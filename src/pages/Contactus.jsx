...
export default function ContactPage() {
  ...
  // ==================================================
  // UPDATED HANDLE SUBMIT — POPUP ADDED
  // ==================================================
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.status === "success") {
        ...
        showPopup("Mail error: " + result.message, "error");
      }
    } catch (error) {
  ...
  // --------------------------------------------------------------------
  // (Everything below is SAME UI — NOTHING CHANGED)
  // --------------------------------------------------------------------
  ...
  return (
    <section ref={sectionRef} className="relative w-full bg-gray-100 py-20 md:py-45 overflow-hidden">

      {/* 🔥 POPUP MESSAGE */}
      {popupMessage && (
        <div
          className={`fixed top-6 left-1/2 -translate-x-1/2 px-6 py-4 rounded-xl shadow-xl text-white text-lg font-semibold z-[9999]
      ...
      {/* ==== REST OF YOUR FULL UI BELOW (UNCHANGED) ==== */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <span className="text-[#d1a32c] text-sm font-bold tracking-[0.3em] uppercase">Get In Touch</span>
            <div className="h-px w-16 bg-gradient-to-l from-transparent to-[#d1a32c]"></div>
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-5xl font-medium text-[#203370] mb-6" style={{ fontFamily: '"Outfit", sans-serif' }}>
            Contact <span className="text-[#d1a32c]">Us</span>
          </h1>

          <p className="text-gray-600 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed" style={{ fontFamily: '"Inter", sans-serif' }}>
            Have questions about our projects? We're here to help you find your dream home.
          </p>
        </div>

        {/* Contact Info Cards */}
        <div className={`grid md:grid-cols-3 gap-8 mb-20 transition-all duration-1000 delay-200 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          {contactInfo.map((info, index) => (
            <div key={index} className="group bg-white border-2 border-gray-200 rounded-3xl p-8 hover:border-[#d1a32c] hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              {/* Icon */}
              <div
                className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${
                  info.color === "blue" ? "from-[#203370] to-[#2a4596]" : "from-[#d1a32c] to-[#e6b84d]"
              ...
              <h3 className="text-2xl font-bold text-[#203370] mb-4" style={{ fontFamily: '"Outfit", sans-serif' }}>{info.title}</h3>

              <div className="space-y-2">
                {info.details.map((detail, idx) => (
                  <p key={idx} className="text-gray-600 text-base" style={{ fontFamily: '"Inter", sans-serif' }}>
                    {detail}
                  </p>
                ))}
              </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          {/* Contact Form */}
          <div className={`lg:col-span-3 transition-all duration-1000 delay-400 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
            <div className="bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-3xl p-8 md:p-10 shadow-xl">
              <h3 className="text-3xl md:text-4xl font-bold text-[#203370] mb-3" style={{ fontFamily: '"Outfit", sans-serif' }}>
                Send Us a Message
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-sm font-semibold text-[#203370] mb-2" style={{ fontFamily: '"Inter", sans-serif' }}>
                    Full Name *
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-6 py-4 border-2 rounded-xl transition-all duration-300 outline-none ${
                        focusedField === "name" ? "border-[#d1a32c] bg-white shadow-lg" : "border-gray-200 bg-white"
                      }`}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-6 py-4 border-2 rounded-xl transition-all duration-300 outline-none ${
                        focusedField === "phone" ? "border-[#d1a32c] bg-white shadow-lg" : "border-gray-200 bg-white"
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-6 py-4 border-2 rounded-xl transition-all duration-300 outline-none ${
                        focusedField === "email" ? "border-[#d1a32c] bg-white shadow-lg" : "border-gray-200 bg-white"
                      }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-6 py-4 border-2 rounded-xl transition-all duration-300 outline-none resize-none ${
                      focusedField === "message" ? "border-[#d1a32c] bg-white shadow-lg" : "border-gray-200 bg-white"
                    }`}
          ...
          {/* Right Sidebar */}
          <div className={`lg:col-span-2 space-y-8 transition-all duration-1000 delay-600 ${inView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
            <div
            ...
            <div className="bg-gradient-to-br from-[#d1a32c] to-[#e6b84d] rounded-3xl p-8 text-white shadow-xl">
              <h4 className="text-2xl font-bold mb-4" style={{ fontFamily: '"Outfit", sans-serif' }}>
                Office Hours
              </h4>
