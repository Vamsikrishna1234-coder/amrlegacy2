...
const Footer = () => {
  ...
  const navigate = useNavigate();  // ⭐ REQUIRED for onClick navigation
    ...
    <footer className="text-white" style={{ backgroundColor: navy }}>
      <div className="max-w-7xl mx-auto px-20 py-25 grid grid-cols-1 md:grid-cols-4 gap-15">
        ...
        <div>
          ...
          {/* ⭐ FIXED CLICK NAVIGATION */}
          <ul className="space-y-3 text-white-300 text-sm">
            <li onClick={() => navigate("/")} className="hover:text-white transition cursor-pointer">Home</li>
            <li onClick={() => navigate("/about")} className="hover:text-white transition cursor-pointer">About Us</li>
            <li onClick={() => navigate("/blogs")} className="hover:text-white transition cursor-pointer">Blogs</li>
            <li onClick={() => navigate("/contact")} className="hover:text-white transition cursor-pointer">Contact Us</li>
          </ul>
        </div>
